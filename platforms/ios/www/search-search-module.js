...
var SearchPageModule = /** @class */ (function () {
    ...
    SearchPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_search_page__WEBPACK_IMPORTED_MODULE_6__["SearchPage"], _pipes_filter_pipe__WEBPACK_IMPORTED_MODULE_8__["FilterPipe"]]
        })
    ], SearchPageModule);
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>\n      Search\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <form>\n    <ion-item>\n      <ion-input type=\"text\" [(ngModel)]=\"searchText\" name=\"title\" placeholder=\"search\"></ion-input>\n    </ion-item>\n  </form>\n  <ion-item *ngFor=\"let user of usersArray | filter: searchText\">\n    <ion-label co>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{user}}</ion-label>\n  </ion-item>\n</ion-content>"
    ...
    function SearchPage(http) {
        ...
        this.http.get(this.url).subscribe(function (data) {
            ...
            data.json().forEach(function (element) {
                _this.usersArray.push(element.name);
            });
        });
